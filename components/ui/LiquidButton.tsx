...
const liquidbuttonVariants = cva(
	"inline-flex items-center transition-colors justify-center cursor-pointer gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-[color,box-shadow] disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
	{
		variants: {
			variant: {
				default: "bg-transparent text-white hover:scale-105 duration-300 transition",
				destructive:
	...
	return (
		<>
			<Comp
				...
				{...props}
			>
					<div className="absolute top-0 left-0 z-0 h-full w-full rounded-full border border-white/55 bg-white/14 shadow-[0_0_8px_rgba(255,255,255,0.12),0_8px_24px_rgba(0,0,0,0.24),inset_1px_1px_0_rgba(255,255,255,0.75),inset_0_-1px_0_rgba(255,255,255,0.22),inset_0_0_14px_rgba(255,255,255,0.14)] transition-all" />
				<div
						className="absolute top-0 left-0 isolate -z-10 h-full w-full overflow-hidden rounded-full"
					style={{ backdropFilter: 'url("#container-glass")' }}
				/>

					<div className="pointer-events-none z-10 text-white drop-shadow-[0_1px_1px_rgba(0,0,0,0.35)]">{children}</div>
				<GlassFilter />
			</Comp>
		</>
	);
