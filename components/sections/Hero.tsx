        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              ...
              <div className="lg:hidden w-full max-w-[680px] mx-auto sm:mx-0 sm:w-[52%] sm:min-w-[280px] sm:mt-2">
                <img
            ...
            <motion.div
              className="flex flex-col gap-3 text-sm text-gray-800 -mt-8 lg:mt-0"
              variants={itemVariants}
            >
          ...
          <div className="relative hidden lg:flex lg:h-[600px] items-center justify-start lg:-ml-14">
            <motion.div
            ...
            >
              <img
                src="/images/interfaces/Conciergerie%20(4).png"
                alt="Interface Biloki"
                className="w-full h-auto lg:scale-[1.65]"
                width={900}
                height={700}
              />
            </motion.div>
