          ...
          <div className="px-8 md:px-12 py-12">
            ...
            {/* CTA */}
              ...
              <div className="mt-12 text-center">
                <Link href="/commencer-gratuitement" className="inline-block bg-primary text-white font-semibold py-4 px-12 rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105 text-lg">
                  {tCommon("tryFree")}
                </Link>
