      ...
      >
        ...
        <div className="border-t border-gray-100 p-3 sm:p-4 bg-white sm:rounded-b-xl rounded-none">
          <input
            ...
            className="w-full border border-gray-300 rounded-lg sm:rounded-xl px-3 sm:px-4 py-3 sm:py-2.5 focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary text-base sm:text-sm bg-white transition-all shadow-sm"
            disabled={isLoading}
          />
        </div>
      </div>
